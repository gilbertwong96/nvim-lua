--- Credit to ibhagwan
-- https://github.com/ibhagwan/nvim-lua/blob/main/lua/plugins/init.lua
...
local ok, packer = pcall(require('bootstrap'), install_path, compile_path)
...
-- Setup our plugins
packer.startup(require("pluginlist"), config)
