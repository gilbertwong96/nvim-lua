--- Credit to ibhagwan
-- https://github.com/ibhagwan/nvim-lua/blob/main/lua/plugins/bootstrap.lua


local fn = vim.fn  -- Used to call vimscript functions
...
local function packer_bootstrap(install_path, compile_path)
  ...
  if not res then
    if vim.fn.input("Install packer.nvim? (y for yes) ") == "y" then
      ...
      vim.cmd("packadd packer.nvim")
      local rs, _packer = pcall(require, "packer")
